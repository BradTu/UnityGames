...
//			Debug.Log ("H");
		...
		if (theCollider.gameObject.tag == "P3Sprite" && theCollider.gameObject.transform.position.x <= this.transform.position.x) {
			if (poleLeft != null) {
				poleLeft.GetComponent<PoleAttackAI> ().StartLeftAttack ();
			}
		}
		...
		if (theCollider.gameObject.tag == "P4Sprite" && theCollider.gameObject.transform.position.x <= this.transform.position.x) {
			if (poleLeft != null) {
				poleLeft.GetComponent<PoleAttackAI> ().StartLeftAttack ();
			}
		}
